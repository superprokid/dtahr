<template>
  <div id="logo" class="container">
    ...
    <div class="row 1">
      ...
      <div class="cell size-12 red"></div>
      <!-- <div class="cell size-6 blue"></div> -->
      <div class="cell size-8"></div>
    </div>
    <div class="row 2">
      <div class="cell size-4"></div>
      <div class="cell size-3-5"></div>
      <div class="cell size-4 red"></div>
      <div class="cell size-12 yellow"></div>
      <div class="cell size-5"></div>
      <div class="cell size-6 blue"></div>
      ...
      <div class="cell size-4-5"></div>
      <div class="cell size-13 blue"></div>
    ...
    <div class="row 3">
      ...
      <div class="cell size-4"></div>
      <div class="cell size-6-5 yellow"></div>
      <div class="cell size-6-5 purple"></div>
      <div class="cell size-8"></div>
    </div>
    <div class="row 4">
      <div class="cell size-7"></div>
      ...
      <div class="cell size-7"></div>
      <div class="cell size-13 red"></div>
      <div class="cell size-9"></div>
      <div class="cell size-6 red"></div>
      <div class="cell size-2"></div>
      <div class="cell size-6 yellow"></div>
    ...
    <div class="row 8">
      ...
      <div class="cell size-2 blue"></div>
      <div class="cell size-5-5"></div>
      <div class="cell size-12 blue"></div>
      <div class="cell size-11 red"></div>
      <div class="cell size-2"></div>
    </div>
    <div class="row 9">
      <div class="cell size-8"></div>
      <div class="cell size-8 purple"></div>
      <div class="cell size-10 red"></div>
      <div class="cell size-8"></div>
    ...
    <div class="row 10">
      ...
      <div class="cell size-13 purple"></div>
      <div class="cell size-3"></div>
      <div class="cell size-6 purple"></div>
