    ...
    <v-app>
        <v-container class="border p-3">
            <div class="">
                ...
                <v-row>
                    <v-col cols="12" lg="6">
                        <span style="display: block; color: #b71c1c; font-size: 15px;" v-if="isStartDateEmpty">
                            Start Date required!
                        </span>
                    </v-col>

                    <v-col cols="12" lg="6">
                        <span style="display: block; color: #b71c1c; font-size: 15px;" v-if="isStartTimeEmpty">
                            Start time required!
                        </span>
                    </v-col>
                ...
                <v-row>
                    <v-col cols="12" lg="6">
                        <span style="display: block; color: #b71c1c; font-size: 15px;" v-if="isEndDateEmpty">
                            End Date required!
                        </span>
                    </v-col>

                    <v-col cols="12" lg="6">
                        <span style="display: block; color: #b71c1c; font-size: 15px;" v-if="isEndTimeEmpty">
                            End time required!
                        </span>
                    </v-col>
                ...
                <div class="mt-10">
                    <v-textarea filled name="input-7-4" label="Reason *" v-model="reasonInputValue" @input="onInputReason">
                    </v-textarea>
                </div>
                <span style="display: block;margin-top: -20px; color: #b71c1c; font-size: 15px;" v-if="isReasonEmpty">
                        Reason required!
                </span>
                ...
                <v-row class="justify-end">
                    ...
                    <v-col cols="2">
                        <Button :buttonClass="'md-raised md-primary button-layout'" :buttonTitle="'Reset'" @on-click="onClickResetButton"
                            style="width:100%;" />
                    </v-col>
                </v-row>
